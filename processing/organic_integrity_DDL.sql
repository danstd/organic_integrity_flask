...
op_nopOpID VARCHAR(256) NOT NULL,
op_name VARCHAR(256),
op_otherNames VARCHAR(256),
...
PRIMARY KEY (op_nopOpID)
);

create table organic_item (
ci_nopOpID VARCHAR(256),
...
ci_itemList VARCHAR(256),
ci_varieties VARCHAR(256),
...
ci_artID INTEGER NOT NULL AUTO_INCREMENT,  -- Artificial primary key added in.
